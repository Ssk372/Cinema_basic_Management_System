 ...
 * @author Axel
 */
public class EditarGenero extends javax.swing.JFrame {

    /**
     * Creates new form EditarGenero
     */
...
DBGenero c1 =  new DBGenero();
        List<Encapsulamientogenero> Listas= c1.mostrargenero(this.id);
        for(Encapsulamientogenero obGenero : Listas){
lblid.setText(""+obGenero.getId());
txtgenero.setText(obGenero.getGenero());
   ...
   e1.setGenero(genero);
     ...
     boolean res = c1.actualizarGenero(e1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarGenero().setVisible(true);
            }
        });
    }
