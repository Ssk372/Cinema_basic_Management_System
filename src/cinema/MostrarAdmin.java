...
List<EncapsulamientoUsuario> Listas= c1.mostraradmin();
DefaultTableModel modeloTabla = (DefaultTableModel) tblusr.getModel();
while (modeloTabla.getRowCount()>0){
modeloTabla.removeRow(0);

}
for(EncapsulamientoUsuario usr : Listas){
